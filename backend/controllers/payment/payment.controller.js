...
let instance = new Razorpay({
  key_id: "rzp_live_ga0ONC1suXLJ8v", // your `KEY_ID`
  key_secret: "fD3qe7ILrdW9SgcpRhDclc4G", // your `KEY_SECRET`
});

// let instance = new Razorpay({
//     key_id: 'rzp_test_QcAnckR9OpdUpt', // your `KEY_ID`
//     key_secret: 'nrUIoje1eEWvfD4YGtS8yvRM' // your `KEY_SECRET`
// });

//rzp_test_QcAnckR9OpdUpt
...
class PaymentController {
  ...
  async get_order_id(req, res, next) {
    try {
      console.log(req.body);
      if (
        !utils.hasParams(req.body.params, [
          "amount",
          "currency",
          "receipt",
          "payment_capture",
  ...
  async verify_order(req, res, next) {
    try {
      let body =
        req.body.params.razorpay_order_id +
        "|" +
        req.body.params.razorpay_payment_id;
      ...
      if (expectedSignature === req.body.params.razorpay_signature) {
        ...
        let transaction_response = paymentservice.record_transaction_details(
          req.body
        );
